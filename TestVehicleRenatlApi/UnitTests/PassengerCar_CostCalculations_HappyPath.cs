...
namespace VehicleRentalApiTest.UnitTests
{
    ...
    public class PassengerCar_CostCalculations_HappyPath
    {
        ...
        public void CalulateCostForPassengerCar(string categoryCode)
        {
            ...
            const int cDayRent = 250;                            // Should be the same as in table Category
            const int cKilometreBasePrice = 0;                  // Should be the same as in table Category
        ...
        public void ThreeDayRentOfPassengerCarCostIsCorrect()
        {
            ...
            const int Const_TwentyFourHourBasePrice = 250; // Should be the same as in db table Category for Passenger car
            var volvo = new PassengerCar(new Vehicle
            {
                CategoryCode = "P"
            });
